...
This extension now supports Azure DevOps work items similar to GitHub issues functionality.
...
The implementation is designed to be easily extended with Azure DevOps MCP (Model Context Protocol) tools for real API integration.
