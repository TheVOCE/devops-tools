 ...
 */
function getAzureDevOpsHostname() {
    const config = vscode.workspace.getConfiguration("voce");
    const customHostname = config.get("azd_customhostname");
 ...
 */
export function getAzureDevOpsOrgUrl(orgName) {
 ...
 */
export function getAzureDevOpsWorkItemUrl(orgName, projectName, workItemId) {
    const hostname = getAzureDevOpsHostname();
 ...
 */
export function getAzureDevOpsPullRequestUrl(orgName, projectName, repoName, pullRequestId) {
    const hostname = getAzureDevOpsHostname();
...
export function parseAzDevOpsValuesFromPrompt(request, stream) {
 ...
 */
export function parseAzDevOpsValuesFromPromptSilent(request) {
 ...
 */
export async function getAzureDevOpsConnection(orgUrl) {
