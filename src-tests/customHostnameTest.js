...
try {
    const defaultOrgUrl = (0, azDevOpsUtils_1.getAzureDevOpsOrgUrl)("myorg");
    ...
    const defaultWorkItemUrl = (0, azDevOpsUtils_1.getAzureDevOpsWorkItemUrl)("myorg", "myproject", 123);
    ...
    const defaultPrUrl = (0, azDevOpsUtils_1.getAzureDevOpsPullRequestUrl)("myorg", "myproject", "myrepo", 456);
...
//# sourceMappingURL=customHostnameTest.js.map